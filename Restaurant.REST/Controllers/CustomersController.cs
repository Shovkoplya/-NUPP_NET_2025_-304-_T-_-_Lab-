...
namespace Restaurant.REST.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        /// <summary>
        /// Отримати всіх клієнтів (тільки для адміністраторів та менеджерів)
        /// </summary>
        ...
        /// <summary>
        /// Отримати клієнта за ID (всі авторизовані користувачі)
        /// </summary>
        ...
        /// <summary>
        /// Створити нового клієнта (всі авторизовані користувачі)
        /// </summary>
        ...
        /// <summary>
        /// Оновити дані клієнта (всі авторизовані користувачі)
        /// </summary>
        /// <param name="id">ID клієнта</param>
        ...
        /// <summary>
        /// Видалити клієнта (тільки для адміністраторів)
        /// </summary>
        /// <param name="id">ID клієнта</param>
